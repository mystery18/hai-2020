...
(function ($) {
    ...
    $.fn.share = function ($options) {
        ...
        this.each(function () {
            ...
            //添加utag事件
            $container.off("click", ".social-share-icon").on("click", ".social-share-icon", function () {
                var cmd = $(this).data("cmd");
                //console.log(site);
                if ( typeof(utShare) != "undefined" && typeof (utShare) == "function") {
                    utShare(cmd);
                }
            });
        ...
        function createIcons($container, $data) {
            ...
            $.each($data.mode == 'prepend' ? $sites.reverse() : $sites, function (i, $name) {
                ...
                if ($container.data("show-text")) {
                    ...
                    var $link = $data.initialized ? $container.find('.icon-' + $name) : $('<a rel="nofollow" class="social-share-icon icon-' + $name + '" data-cmd="' + $name + '"' + $target + '><i class="iconfont icon-share-' + $name + '"></i><span class="text">' + dataName + '</span></a>');
                } else {
                    var $link = $data.initialized ? $container.find('.icon-' + $name) : $('<a rel="nofollow" class="social-share-icon icon-' + $name + '" data-cmd="' + $name + '"' + $target + ' data-name="' + dataName + '"><i class="iconfont icon-share-' + $name + '"></i></a>');
                }
